...
const Books = (props) => {
    // console.log(props);
    const {articleStyles, title, author, image, children} = props;
    const displayTitle = () => {
     ...
     return (
        ...
        <article className={articleStyles}>
            ...
            {children}
            <button onClick={displayTitle} className='bg-green-400 mt-2 uppercase rounded-sm text-white p-1 text-xs'>Display Title</button>
        </article>
    );
}
